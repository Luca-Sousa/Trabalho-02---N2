/* Considere uma pilha que armazene caracteres. Faça uma função para
determinar se uma string é da forma XY, onde X é uma cadeia formada por
caracteres arbitrários e Y é o reverso de X. Por exemplo, se x = ABCD, então y =
DCBA. Considere que x e y são duas strings distintas.
